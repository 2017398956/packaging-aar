...
class FlavorArtifact {
    ...
    static ResolvedArtifact createFlavorArtifact(Project project, LibraryVariantImpl variant, ResolvedDependency unResolvedArtifact) {
    ...
    private static TaskProvider getBundleTask(Project project, LibraryVariantImpl variant) {
