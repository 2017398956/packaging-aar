...
class VersionAdapter {
    ...
    private LibraryVariantImpl mVariant

    VersionAdapter(Project project, LibraryVariantImpl variant) {
        mProject = project
        mVariant = variant
    }
    ...
    static File getOutputFile(Project project, LibraryVariantImpl variant) {
        if (FatUtils.compareVersion(AGPVersion, "3.3.0") >= 0) {
    ...
    static TaskProvider<Task> getBundleTaskProvider(Project project, LibraryVariantImpl variant) throws UnknownTaskException {
